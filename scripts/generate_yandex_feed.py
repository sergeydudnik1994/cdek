...
SERVICES_CATALOG = [
    ...
    {"slug": "storage-services", "cat": "4", "name": "Ответственное хранение товаров", "price": "5", "desc": "Складское хранение товаров селлеров на современных складах СДЭК с круглосуточной охраной и видеонаблюдением."},
    ...
    {"slug": "pudo-delivery", "cat": "3", "name": "Доставка заказов в пункты выдачи (ПВЗ)", "price": "136", "desc": "Выдача отправлений через разветвленную сеть более 4000 отделений СДЭК по всей России с высоким клиентским рейтингом."},
    ...
    {"slug": "dogovor-ip", "cat": "2", "name": "Заключение договора со СДЭК для ИП и ООО", "price": "500", "desc": "Бесплатное оформление корпоративного договора со СДЭК для юридических лиц со скидками на логистику до 50%."},
    {"slug": "api-integration", "cat": "2", "name": "Интеграция со СДЭК по API и модулям", "price": "500", "desc": "Подключение CMS интернет-магазинов и учетных систем к логистическому шлюзу СДЭК для автоматического создания накладных."},
    ...
    # 5. Специализированные решения по маркетплейсам (category id=3 / 4)
    {"slug": "fbs/ozon", "cat": "3", "name": "Логистика FBS для Ozon", "price": "136", "desc": "Официальная доставка заказов селлеров Ozon по схеме FBS через пункты приема и сортировочные хабы СДЭК."},
    ...
    {"slug": "fbs/yandex-market", "cat": "3", "name": "Логистика FBS для Яндекс Маркета", "price": "136", "desc": "Интеграция и быстрая отгрузка заказов продавцов Яндекс Маркета через логистическую инфраструктуру СДЭК."},
...
def generate_feed():
    ...
    # 2. Генерация предложений (offers)
    for idx, s in enumerate(SERVICES_CATALOG):
        ...
        yml_lines.append('        <name>СДЭК Маркетплейс</name>')
    ...
    print(f"✅ Фид сгенерирован: {len(SERVICES_CATALOG)} сетов и предложений без ошибок модерации.")
