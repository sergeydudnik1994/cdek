...
// ⚠️ УКАЖИТЕ ВАШИ БОЕВЫЕ ДАННЫЕ ИЗ ЛИЧНОГО КАБИНЕТА СДЭК
$clientId = 'ВАШ_БОЕВОЙ_CLIENT_ID';
$clientSecret = 'ВАШ_БОЕВОЙ_CLIENT_SECRET';
$apiDomain = 'api.cdek.ru'; // Боевой сервер СДЭК
...
// Функция получения кода города по названию
function getCdekCityCode($cityName, $apiDomain, $accessToken) {
    // Добавили параметр country_codes=RU для точного поиска по РФ
